...
<head>
   <meta charset="UTF-8">
   <title>Jumping Jack Technic </title>
         ...
         <div class="row">
            <div class="col-md-12">
               <div class="prod-page-title">
                  <h2>Jumping Jack Technic</h2>
                  <p>By <span>XXXX</span></p>
               </div>
            </div>
         </div>
         <div class="row">
            <div class="col-md-2 col-sm-4">
               <div class="left-profile-box-m prod-page">
                  <div class="pro-img">
                     <img src="a/images/150x150.png" alt="#" />
                  </div>
                  <div class="pof-text">
                     <h3>XXXX</h3>
                     ...
                     <div class="spe-a">
                        ...
                        <ul>
                           <li class="clearfix">
                              ...
                              <div class="col-md-8">
                                 <p>Max 20 Menit 1 Hari, 2x Sesi 10X2  </p>
                              </div>
                           </li>
                           <li class="clearfix">
                              <div class="col-md-4">
                              ...
                              <div class="col-md-8">
                                 <p>Max 10 Menit 1 Hari, 2x Sesi 10X2</p>
                              </div>
                           </li>
                           <li class="clearfix">
                              <div class="col-md-4">
               ...
               <div class="similar-box">
                  ...
                  <div class="row cat-pd">
                     <div class="col-md-6">
                        <div class="small-box-c">
                           <div class="small-img-b">
                              <img class="img-responsive" src="https://www.wikihow.com/images_en/thumb/7/72/Do-Pull-Ups-Without-a-Bar-Step-2.jpg/v4-460px-Do-Pull-Ups-Without-a-Bar-Step-2.jpg.webp" alt="#" />
                           </div>
                     ...
                     <div class="col-md-6">
                        <div class="small-box-c">
                           <div class="small-img-b">
                              <img class="img-responsive" src="https://i2.wp.com/beritatangsel.com/wp-content/uploads/2017/02/i.jpg?fit=550%2C500&ssl=1" alt="#" />
                           </div>
                           <div class="dit-t clearfix">
                              <div class="left-ti">
                                 <h4>Sit Up</h4>
                  ...
                  <div class="row cat-pd">
                     <div class="col-md-6">
                        <div class="small-box-c">
                           <div class="small-img-b">
                              <img class="img-responsive" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRxeOJSdR9w6E_X-Dd2PxcvrNJRrHRPKkeVXMVMWrNVnx08zI_h_2fY8Qio2vyVkRViQas&usqp=CAU" alt="#" />
                           </div>
                           <div class="dit-t clearfix">
                              <div class="left-ti">
                                 <h4>Dips Squat</h4>
                     ...
                     <div class="col-md-6">
                        <div class="small-box-c">
                           <div class="small-img-b">
                              <img class="img-responsive" src="https://fitpass-images.s3.amazonaws.com/content_blog_inner_64A71045.png" alt="#" />
                           </div>
                           <div class="dit-t clearfix">
                              <div class="left-ti">
