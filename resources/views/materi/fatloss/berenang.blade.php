                ...
                <div class="col-md-7 col-sm-8">
                    <div class="md-prod-page">
                                ...
                                <div class="preview">
                                    <div class="preview-pic tab-content">
                                        <div class="tab-pane active" id="pic-1">
                                            <img src="a/images/renang.jpg" alt="#" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="description-box">
                            <div class="dex-a">
                                <h4>Description</h4>
                                <p>Berenang yang menggerakkan semua organ tubuh ini juga ampuh untuk menurunkan berat badan. Selain itu dengan berenang
                                kesehatan paru-paru dan juga jantung Anda akan meningkat. Faktanya, renang yang dilakukan selama 30 menit mampu membakar
                                sekitar 200–300 kalori
                                </p>
                            </div>
                        </div>
                    </div>
