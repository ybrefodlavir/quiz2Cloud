                  ...
                  <div class="col-md-8 col-sm-12">
                     <div class="right-nav">
                        <div class="login-sr">
                           <div class="login-signup">
                              <ul>
                                ...
                                <li><a class="custom-b" href="category.html">More</a></li>
                              </ul>
                           </div>
                        </div>
                        <div class="help-r hidden-xs">
                           <div class="help-box">
                              <ul>
                                 <li> <a data-toggle="modal" data-target="#myModal" href="profile.html"> <span>Profile</span> <img  alt="" /> </a> </li>
                                 <li> <a href="pricing.html"><img class="h-i" src="images/help-icon.png" alt="" /> Pricing </a> </li>
                              </ul>
                           </div>
                        </div>
                     ...
                     <div class="furniture-middle">
                        <div class="big-box">
                           ...
                           <div class="big-dit-b clearfix">
                              <div class="col-md-6">
                                 <div class="left-big">
                                    <h3>Open Recruitment Our Company</h3>
                              ...
                              <div class="col-md-6">
                                 <div class="right-big-b">
                                    <div class="tight-btn-b clearfix">
                                       <a class="view-btn" href="register.html">Register</a>
                                    </div>
                                    <div class="like-list">
                                       <ul>
                                          <li>
