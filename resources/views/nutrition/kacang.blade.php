                ...
                <div class="col-md-7 col-sm-8">
                    <div class="md-prod-page">
                                ...
                                <div class="preview">
                                    <div class="preview-pic tab-content">
                                        <div class="tab-pane active" id="pic-1">
                                            <img src="a/images/kacang_merah.jpg" alt="#" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="description-box">
                            <div class="dex-a">
                                <h4>Description</h4>
                                <p>Kacang hitam, kacang pinto, dan kacang merah merupakan sumber protein yang tidak kalah unggul dari kacang kedelai.
                                Ketiganya mengandung 15 gram protein untuk setiap 172 gram kacang matang, atau sekitar 25% kebutuhan menurut AKG.
                                
                                Kacang-kacangan ini juga kaya vitamin dan mineral yang penting bagi otot, seperti vitamin B, mineral magnesium, zat
                                besi, dan fosfor. Dengan adanya zat gizi ini, tidak mengherankan bila kacang-kacangan diandalkan sebagai makanan
                                pembentuk otot
                                </p>
                            </div>
                        </div>
