    ...
    <div class="product-page-main">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-7 col-sm-8">
                    <div class="md-prod-page">
                                ...
                                <div class="preview">
                                    <div class="preview-pic tab-content">
                                        <div class="tab-pane active" id="pic-1">
                                            <img src="a/images/gandum.jpg" alt="#" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="right-dit-p">
                                    <div class="like-list">
                                        <ul>
                                            <li>
                                                <div class="im-b">
                                                    <img class="" src="a/images/list-img-01.png" alt="">
                                                </div>
                                            </li>
                                            <li>
                        ...
                        <div class="description-box">
                            <div class="dex-a">
                                <h4>Description</h4>
                                <p>Beberapa jenis biji-bijian serealia memang disebut kurang baik bagi orang yang menjalani program menurunkan berat badan.
                                Untungnya, ada sejumlah jenis gandum utuh yang bisa dijadikan sebagai makanan penurun berat badan.
                                
                                Biji-bijian ini kaya akan serat dan mengandung protein yang cukup menjalani aktivitas harian. Salah satu jenis gandum
                                utuh yang bisa Anda manfaatkan yakni oat.
                                
                                Oat merupakan biji-bijian serealia yang kaya akan beta-glukan, yaitu serat larut yang terbukti meningkatkan perasaan
                                kenyang. Selain perasaan kenyang, jenis serat larut ini berperan penting dalam proses metabolisme.
                                
                                Tidak hanya oat, Anda dapat memanfaatkan gandum utuh lainnya, terutama beras cokelat dan quinoa guna menurunkan berat
                                badan.
                                </p>
                            </div>
                        </div>
                ...
                <footer>
                    ...
                    <div class="copyright">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-8">
                                    <p><img width="90" src="a/images/logo.png" alt="#" style="margin-top: -5px;" /> All
                                ...
                                <div class="col-md-4">
                                    ...
                                    <ul class="right-flag">
                                        <li><a href="#"><img src="a/images/flag.png" alt="" /> <span>Change</span></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <script src="a/js/select2.full.min.js"></script>
