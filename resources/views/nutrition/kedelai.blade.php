                ...
                <div class="col-md-7 col-sm-8">
                    <div class="md-prod-page">
                                ...
                                <div class="preview">
                                    <div class="preview-pic tab-content">
                                        <div class="tab-pane active" id="pic-1">
                                            <img src="a/images/kedelai.jpeg" alt="#" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="btn-dit-list clearfix">
                                ...
                                <div class="right-dit-p">
                                    <div class="like-list">
                                        <ul>
                                            <li>
                                                <div class="im-b"><img class="" src="a/images/list-img-01.png" alt="">
                                                </div>
                                            </li>
                                            <li>
                        ...
                        <div class="description-box">
                            <div class="dex-a">
                                <h4>Description</h4>
                                <p>Kacang kedelai merupakan pilihan tepat bila Anda ingin membentuk otot. Seratus gram kedelai matang mengandung 15 gram
                                protein yang setara dengan 25% kebutuhan harian orang dewasa. Selain itu, ada pula kandungan zat besi, vitamin K, dan
                                fosfor.
                                
                                Sumber protein nabati biasanya tidak mengandung asam amino yang lengkap. Namun, lain halnya dengan kacang kedelai. Bahan
                                makanan ini mengandung semua jenis asam amino, khususnya leusin yang sangat dibutuhkan sebagai pembentuk massa otot.
                                </p>
                            </div>
                        </div>
                    </div>
