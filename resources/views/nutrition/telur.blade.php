                ...
                <div class="col-md-7 col-sm-8">
                    <div class="md-prod-page">
                        ...
                        <div class="description-box">
                            <div class="dex-a">
                                <h4>Description</h4>
                                <p>Telur termasuk makanan sumber protein, lemak, dan zat gizi mikro seperti vitamin B kompleks dan kolin. Yang spesial dari
                                protein telur yakni kualitasnya tergolong tinggi. Ini karena protein telur tersusun atas beragam asam amino, khususnya
                                leusin.
                                
                                Leusin merupakan salah satu asam amino yang penting untuk membentuk otot. Asam amino ini berperan langsung dalam
                                pembentukan protein, pembelahan sel, serta metabolisme yang berlangsung dalam otot Anda.
                                </p>
                            </div>
                        </div>
                    </div>
