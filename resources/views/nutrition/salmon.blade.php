                ...
                <div class="col-md-7 col-sm-8">
                    <div class="md-prod-page">
                                ...
                                <div class="preview">
                                    <div class="preview-pic tab-content">
                                        <div class="tab-pane active" id="pic-1">
                                            <img src="a/images/salmon.jpg" alt="#" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="description-box">
                            <div class="dex-a">
                                <h4>Description</h4>
                                <p>Makanan pembentuk otot tidak hanya perlu mengandung protein, tapi juga lemak yang menyehatkan. Kedua zat gizi ini dapat
                                Anda temukan saat Anda makan ikan yang berlemak seperti tuna, salmon, tenggiri, dan sebagainya.
                                
                                Ikan berlemak merupakan sumber asam lemak omega-3. Penelitian menunjukkan bahwa asupan omega-3 membantu menjaga
                                kesehatan otot. Bahkan, lemak tak jenuh ini juga berpotensi menambah massa otot selama Anda menjalani program olahraga
                                </p>
                            </div>
                        </div>
                    </div>
